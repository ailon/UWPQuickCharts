...
namespace Ailon.QuickCharts
{
    ...
    public class SerialChart : Control
    {
        ...
        public SerialChart()
        {
            ...
            this.LayoutUpdated += new EventHandler<object>(OnLayoutUpdated);
        ...
        private void Indicator_PointerEntered(object sender, PointerRoutedEventArgs e)
        {
            DisplayBalloon((Indicator)sender, e.Pointer.PointerDeviceType);
            e.Handled = true;
        }
        ...
        private void OnGraphCanvasPointerEntered(object sender, PointerRoutedEventArgs e)
        {
            if (_balloon != null)
            {
                _balloon.Visibility = Visibility.Collapsed;
            }
            Point position = e.GetCurrentPoint(_graphCanvas).Position;
        ...
        private void OnGraphCanvasPointerExited(object sender, PointerRoutedEventArgs e)
        {
            HideIndicators();
        }
